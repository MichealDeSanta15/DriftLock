"""Alembic environment configuration for DriftLock.

Sets up the database context for migrations using SQLAlchemy models.
"""
...
def get_sqlalchemy_url() -> str:
    ...
    if not db_url:
        raise ValueError(
            ...
            "Set it in .env before running migrations."
        )
    return db_url
